...
//			
			...
			if(jm.getString("UserID").equals("30639") &&  jm.getString("Password").equals("Welcome@1234"))
			{
				JSONObject data1= new JSONObject();
				
				
				data1.put("UID1", jm.getString("UserID").toString());
				data1.put("BRCD", "10001");
				Data.put("Data", data1);
				return new ResponseEntity<Object>(Data, HttpStatus.OK);
			}
			else if(jm.getString("UserID").equals("20512") &&  jm.getString("Password").equals("Welcome@123"))
			{
				JSONObject data1= new JSONObject();
